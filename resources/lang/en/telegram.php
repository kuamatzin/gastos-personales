...
return [
    ...
    'monthly_summary_title' => '📊 *Monthly Expense Summary*\n:month',
    'monthly_summary_weekly_breakdown' => '📅 *Weekly breakdown:*',
    'week' => 'Week',
    'monthly_summary_top_categories' => '🏆 *Top categories:*',
    'monthly_summary_total' => '💰 *Monthly total: $:amount* (:count expenses)',
    'monthly_summary_daily_average' => '📊 *Daily average: $:amount*',
    'monthly_summary_increase' => 'You spent :percent% more than last month (+$:amount)',
    'monthly_summary_decrease' => 'You spent :percent% less than last month (-$:amount)',
    'monthly_summary_same' => 'You spent the same as last month',
    'monthly_summary_most_expensive' => 'Highest expense: :description ($:amount) on :date',
    'monthly_summary_good_month' => 'Excellent expense control this month! 🎯',
    'monthly_summary_diverse_spending' => 'Tip: You have many expense categories. Consider consolidating some for better analysis.',
    'monthly_summary_recurring_payments' => '*Recurring payments:*',
    'monthly_summary_installments' => ':count active installments: $:amount/month',
    'monthly_summary_subscriptions' => ':count active subscriptions: ~$:amount/month',
    'monthly_summary_year_to_date' => 'Total for :year: $:amount',
    'button_enable_monthly_summary' => '✅ Enable monthly summary',
    'button_disable_monthly_summary' => '❌ Disable monthly summary',
    'button_change_monthly_time' => '🕐 Change monthly time',
    'monthly_summary_enabled' => 'Monthly summary active (last day of month)',
    'monthly_summary_enabled_with_time' => 'Monthly summary active (last day at :time)',
    'monthly_summary_disabled' => 'Monthly summary disabled',
    'monthly_summary_enabled_success' => '✅ Monthly summary enabled. You will receive a summary on the last day of each month at 8:00 PM.',
    'monthly_summary_disabled_success' => '❌ Monthly summary disabled.',
    'select_monthly_notification_time' => '🕐 *What time would you like to receive the monthly summary on the last day of the month?*',
    'monthly_summary_time_updated' => '✅ Time updated. You will receive the monthly summary on the last day of the month at :time.',
];
